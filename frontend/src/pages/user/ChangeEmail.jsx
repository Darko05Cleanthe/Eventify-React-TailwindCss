...
export default function ChangeEmail({email}) {
    ...
    return <section className="flex flex-col w-full max-w-screen-lg h-1/2">
            ...
            <h6 className="font-[montserrat] font-bold text-[#2D2C3C] m-4">Change Email</h6>
            <hr className="border-t-2 border[#6F6F6F4D] mx-3"/>

            <form action="get" method="" className="flex flex-col my-5">

                <h6 className="font-[montserrat] font-bold text-[#2D2C3C] m-4">Current Email: {email}</h6>
            ...
            <Link to='' className="relative font-sans font-bold bg-[#2B293D] text-white p-2 rounded-lg px-8 w-[180px] text-nowrap text-sm ml-[118px] my-5">Save New Email</Link>
